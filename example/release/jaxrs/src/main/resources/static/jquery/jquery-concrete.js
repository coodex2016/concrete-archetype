...
(function (factory) {
    ...
    register("ExampleApi", "org.coodex.example", { "add": function (x1, x2) {return invoke({"path": "/Example/add/{x1}/{x2}","param": {"x1": x1, "x2": x2},"method": "GET", "dataType": "json" });}, "aclTest": function () {return invoke({"path": "/Example/aclTest","param": {},"method": "GET", "dataType": "text" });}, "getRandomVeh": function (id) {return invoke({"path": "/Example/vehicles/{id}","param": {"id": id},"method": "GET", "dataType": "text" });}});
