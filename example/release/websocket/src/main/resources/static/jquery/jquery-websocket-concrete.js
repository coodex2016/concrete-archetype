...
(function (factory) {
    ...
    register("ExampleApi", "org.coodex.example", { "add": function (x1, x2) {return invoke({"serviceId": "C13884388C74EF220EA2A033B2F9D9A3ED979284","param": {"x1": x1, "x2": x2} });}, "aclTest": function () {return invoke({"serviceId": "CC4B53D3758C17A723A2B40957BF0B32119BD3DD","param": undefined });}, "getRandomVeh": function (id) {return invoke({"serviceId": "02D2C9E447F76832E0D4586AAAA08CB9056D2A7C","param": id });}});
    if(self){
